...
# Installation
[Download](https://github.com/brndd/scrubbuster/raw/master/releases/ScrubBuster_v0.21.7z) ScrubBuster, and place the archive's contents in the Interface\AddOns\ folder, so that two new
